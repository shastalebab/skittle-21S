...
void initialize() {
	...
	j_auton_selector.jautonpopulate({
		...
		jas::jasauton(red_possolowp, 0, 1, "Red positive solo WP", "Red 4 + 1 + 1 goal side auton", 5, 1, true),
		...
		jas::jasauton(blue_possolowp, 1, 1, "Blue positive solo WP", "Blue 4 + 1 + 1 goal side auton", 5, 1, true),
