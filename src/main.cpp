...
void initialize() {
	...
	j_auton_selector.jautonpopulate({
		...
		jas::jasauton(red_solowp, 0, 0, "Red negative solo WP", "Red 4 + 1 + 1 ring side auton", 5, 1, true),
		...
		jas::jasauton(blue_solowp, 1, 0, "Blue negative solo WP", "Blue 4 + 1 + 1 ring side auton", 5, 1, true),
